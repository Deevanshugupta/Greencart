        ...
        <div className="flex flex-col md:flex-row mt-16 px-10">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm text-green-400">{getCartCount()}</span>
                </h1>
                ...
                className="group cursor-pointer flex items-center mt-8 gap-2 text-green-400 font-medium">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        <button onClick={() => setShowAddress(!showAddress)} className="text-green-400 hover:underline cursor-pointer">
                            Change
                        </button>
                        {showAddress && (
                ...
                <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-green-400 text-white font-medium hover:bg-green-300 transition">
